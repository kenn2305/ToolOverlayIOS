...
static NSInteger gHideDelayMs = 300;      // delay ẨN ảnh 1 (index 0)
static NSInteger gHideDelayMs2 = 300;     // delay ẨN ảnh 2 (index 1) - riêng để canh load tab
static NSInteger gShowDelayMs = 300;      // delay HIỆN ảnh 1 (index 0)
static NSInteger gShowDelayMs2 = 300;     // delay HIỆN ảnh 2 (index 1) - riêng để canh load tab
